...
@Table(
    name = "kpi_reviews",
    indexes = {
        @Index(name = "idx_kpir_mrm",  columnList = "mrm_plan_id"),
        @Index(name = "idx_kpir_cert", columnList = "certification_id")
    }
)
@Data
@Builder
...
public class KpiReview {
    ...
    @CollectionTable(name = "kpi_review_items", joinColumns = @JoinColumn(name = "kpi_review_id"))
    @Builder.Default
